...
def sql_query(from_date: str, to_date: str) -> str:
    ...
    Parameters:
        from_date: Earliest date to check
        to_date: Latest date to check
    Returns:
